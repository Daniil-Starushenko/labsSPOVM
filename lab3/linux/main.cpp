...
int main(int argc, char *argv[])
{
    ...
    //инициализация sharedMemory
    //выделение сегмента разделяемой памяти
    ...
    {   // приведение типов к char*
        //
        //Для непосредственного использования разделяемой памяти необходимо получить адрес сегмента
